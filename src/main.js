      ...
      <main className="MainContent">
        ...
        <MainSection id="trailer">
          ...
          <p className="MainSection-content">
            From 1991-1999 a series of sounds have been detected deep within the
            ocean. All heard around the world, 3000 miles away from the
          ...
          <p className="MainSection-content">
            <strong>6 Main worlds</strong> – Reef, Caves, Sunken Ship, Volcano,
            Deep Ocean, The Depths<br />
